...
class DatabaseConnector:
    ...
    def insertDB(self, category, sub_category, URl, image_url, about, experience, name, title, location, skills):

        logger.info("INSERTING INTO Database...........")
        sql = "INSERT INTO `profiles`(`category`, `sub_category`, `url`, `image_url`, `about`, `experience`, `name`, `title`, `location`, `skills`) VALUES (%s, %s, %s, %s, %s, %s, %s,%s, %s, %s)"
        val = (category, sub_category, URl, image_url, about,
...
if __name__ == "__main__":
    ...
    obj.insertDB("category", "sub_category", "url", "image_url", "about",
